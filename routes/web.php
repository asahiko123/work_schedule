...
Route::get('/sptop',function(){
    return view('welcome');
});
Auth::routes();

Route::get('/sp/home', [App\Http\Controllers\HomeController::class, 'index'])->name('home');
Auth::routes();

Route::group(['prefix'=>'sp/schedule','middleware'=>['auth','can:user-higher']],function(){
    Route::match(['get','post'],'index',[ScheduleController::class,'index'])->name('schedules.index');
});

Route::group(['prefix'=>'sp/schedule','middleware'=>['auth','can:admin-higher']],function(){
